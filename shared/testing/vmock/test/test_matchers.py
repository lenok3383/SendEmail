...
:Status: $Id: //prod/main/_is/shared/python/testing/vmock/test/test_matchers.py#3 $
:Authors: vburenin
"""
...
TEST_APP_NAME = 'vmock_matchers_test'

class TestVmockMatchers(unittest2.TestCase):
    ...
    def test_is_type(self):
        ...
        self.assertFalse(is_type.compare(10L))
    ...
    def test_is_int(self):
        ...
        self.assertTrue(is_int.compare(-10))
        self.assertFalse(is_int.compare(10L))
        self.assertFalse(is_int.compare(10.1))
        self.assertFalse(is_int.compare('rferf'))

    def test_is_long(self):
        is_long = matchers.is_long()
        self.assertTrue(is_long.compare(10L))
        self.assertTrue(is_long.compare(-10L))
        self.assertFalse(is_long.compare(10))
        self.assertFalse(is_long.compare(10.1))
        self.assertFalse(is_long.compare('rferf'))

    def test_is_float(self):
        is_float = matchers.is_float()
        self.assertTrue(is_float.compare(10.1))
        self.assertFalse(is_float.compare(10L))
        self.assertFalse(is_float.compare(-10L))
    ...
    def test_is_number(self):
        ...
        self.assertTrue(is_number.compare(10L))
        self.assertTrue(is_number.compare(-10L))
