...
:Status: $Id: //prod/main/_is/shared/python/testing/vmock/test/test_vmock.py#4 $
:Authors: vburenin
"""
...
from shared.testing.vmock import mockerrors
from shared.testing.vmock.test import some_classes as sc
...
class TestVmockMatchers(unittest2.TestCase):
    ...
    def test_property_mock(self):
        m_class = self.mc.mock_class(sc.SimpleClass, display_name='class')
    ...
    def test_intefrace_check_func_with_one_arg_and_many_kwargs(self):
        s_func = self.mc.stub_method(sc, 'func_with_one_arg_and_many_other_kwargs')
